...
const LocationCarousel: React.FC<LocationCarouselProps> = ({ locationSuggestions, suggestion, style }) => {
  ...
  const pages: LocationSuggestion[][] = [];
  ...
  const renderPage = (pageLocations: LocationSuggestion[], pageIndex: number): JSX.Element => (
